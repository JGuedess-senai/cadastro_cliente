...
class Cliente {
  ...
  final String email;
  final String
  senha; // Em um app real, a senha NÃO é guardada assim! Usaríamos o Firebase Auth.
...
class ServicoClientes {
  ...
  final CollectionReference _colecao = FirebaseFirestore.instance.collection(
    'clientes',
  );
